...
{
    private SchemaLoaderService $schemaLoader;

    public function __construct(SchemaLoaderService $schemaLoader)
    {
    ...
    private function mapOperationToSchema(string $operation): string
    {
        $mapping = [
        ...
        return $mapping[$operation] ?? 'checkout';
    }
}
